...
class contrast_model(nn.Module):
    def __init__(self,  pretrained=False):
        ...
        self.model = timm.create_model('efficientnet_b1',pretrained=True,num_classes=6)
        self.model.load_state_dict(torch.load("store\\pth_\\efficientnet_b1_500_0001_N1.pth"))
